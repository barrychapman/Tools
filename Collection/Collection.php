...
class Collection
{
    ...
    /*
        get all objects based on one of it's properties.
        i.e. a User object with the property 'username' and a value of 'someUser'
            can be retrieved by Collection::getByProperty('username', 'someUser')
            requires object has a getter method
            with the same spelling as the property, i.e. getUsername()
    */
	
    public function getAllByProperty($propertyName, $property)
    {
    ...
    /*
        get an object based on one of it's properties.
        requires that the object has a getter method
            with the same spelling as the property, i.e. getUsername()
    */
    /**
     * @param $propertyName
    ...
    */
    ...
    /*
        ...
        i.e. if there are objects with a property of 'verified' set to 1
    ...
    */
    ...
    /*
        remove an object based on one of it's properties.
        i.e. a User object with the property 'username' and a value of 'someUser'
            can be removed by Collection::removeByProperty('username', 'someUser')
        --    assumes that the object has a getter method
            with the same spelling as the property, i.e. getUsername()
    */
    ...
    */
	...
	/*
	 *		Resets internal iterating pointer
	 */
